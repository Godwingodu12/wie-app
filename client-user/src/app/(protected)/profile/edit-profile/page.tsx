...
function EditProfileContent() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white font-sans selection:bg-[#5E5CE6] selection:text-white">
      <SideBar />
      ...
      >
        <div className="max-w-[600px] mx-auto px-6 py-6 md:py-12">
            ...
            <div className="relative mb-4 group cursor-pointer">
              {displayUser?.profile_picture ? (
                <img
                  ...
                  alt="Profile"
                  className="w-[88px] h-[88px] rounded-full object-cover border-[3px] border-[#1C1C1E]"
                />
              ) : (
                <img
               ...
               {/* Visual Only - No File Upload Logic Yet */}
               <div className="absolute inset-0 bg-black/30 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                   <Camera size={20} className="text-white" />
               </div>
            </div>
            <button className="text-[#0095F6] text-[15px] font-medium hover:text-[#0085db] transition-colors">
          ...
          <div className="space-y-6">
            ...
            {/* Name */}
            <div className="mb-2">
               <label className="block text-[#6E6E73] text-[15px] mb-2 px-1">Name</label>
            ...
            {/* Username */}
            <div className="mb-2">
               <label className="block text-[#6E6E73] text-[15px] mb-2 px-1">Username</label>
               <div className="bg-[#1C1C1E] rounded-[12px] overflow-hidden">
                 <input
                    type="text"
                    name="username"
             ...
             {/* Bio */}
             <div className="mb-2">
               <label className="block text-[#6E6E73] text-[15px] mb-2 px-1">Bio</label>
               <div className="bg-[#1C1C1E] rounded-[12px] overflow-hidden">
                 <textarea
                    name="bio"
                    value={formData.bio}
             ...
             <div className="mb-2">
               <label className="block text-[#6E6E73] text-[15px] mb-2 px-1">Country</label>
               <div className="relative bg-[#1C1C1E] rounded-[12px] overflow-hidden">
                 ...
                 <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                   <ChevronLeft size={20} className="text-gray-500 rotate-[-90deg]" />
                 </div>
               </div>
            </div>
