      ...
      <div className={`${isMobile ? 'p-4 pt-8' : 'p-5 md:p-10'} relative z-10`}>
        ...
        <div className="flex justify-between items-start mb-6 md:mb-8">
          ...
          <div className="relative z-20">
            ...
            >
              {loggingOut ? <Loader2 size={20} className="animate-spin" /> : <Menu size={20} />}
            </button>
            {isMenuOpen && (
              <>
        ...
        <div className="flex flex-col items-center w-full px-4 md:px-10 mb-8">
          ...
          <div className="flex flex-col items-center gap-6 mb-8 w-full max-w-lg">
            ...
            <div className="relative">
              ...
              {/* Small Plus Icon on Avatar - Now clickable */}
              <label
                htmlFor="avatar-upload"
                className={`absolute bottom-1 right-1 bg-[#2C2C2E] p-1.5 rounded-full border-[3px] border-[#0a0a0a] z-10 cursor-pointer hover:bg-[#3C3C3E] transition-colors ${
          ...
          <div className={`flex flex-wrap justify-center gap-2 md:gap-3 w-full max-w-2xl px-0 md:px-2 mb-8`}>
            {/* Edit Profile */}
            <button
