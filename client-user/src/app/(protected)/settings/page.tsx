...
import { updatePersonalDetails, UpdatePersonalDetailsRequest } from '@/services/wieUserService';
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingField === 'dob' && editValue) {
        ...
        payloadValue = null; // Send null or empty to clear it if allowed, though typically handled by backend
      }

      const payload = { [editingField]: payloadValue };
