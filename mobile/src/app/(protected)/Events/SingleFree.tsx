...
// Added hideHeader prop to handle MultiEvents integration
interface SingleFreeProps {
  hideHeader?: boolean;
}

const SingleFree = ({ hideHeader = false }: SingleFreeProps) => {
    ...
    <View className="flex-1 bg-black">
      ...
      <View>
        ...
        >
          ...
          >
            {/* CONDITIONAL HEADER ACTIONS: Hidden when viewed as a sub-event */}
            {!hideHeader && (
              <View 
            ...
            <View className="flex-row items-center mb-1 flex-wrap">
              <Text style={{ fontSize: isSmallDevice ? 24 : 32 }} className="text-white font-rubik-bold mr-2">
                {EVENT_DATA.title}
              </Text>
            ...
            >
              {tab === "About" && (
                <View className="mt-2">
                  ...
                  <InfoRow icon="cube" label={EVENT_DATA.about.price} color="#8B5CF6" />
      ...
      {/* --- FOOTER: Now triggers BookingSheet --- */}
      <View 
      ...
      >
        <EventFooterButtons 
          onLeftPress={() => setIsLiked(!isLiked)}
          onRightPress={() => setIsSheetVisible(true)} // Opens the sheet
        />
      </View>
      ...
      <BookingSheet 
        ...
        eventData={{
          ...
          image: EVENT_DATA.headerImage,
          date: EVENT_DATA.about.dateTime,
          location: EVENT_DATA.about.address
        }}
      />
    </View>
  );
