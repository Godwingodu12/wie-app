      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="mt-4 px-5">
           <View className="flex-row justify-between items-center mb-4">
              ...
              <TouchableOpacity>
                 <Text className="text-primary text-[12px] font-rubik-bold">82</Text>
              </TouchableOpacity>
           </View>
           <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 8 }}>
              {[1, 2, 3, 4, 5].map((i) => (
                <View key={i} className="w-20 h-20 rounded-xl bg-[#1C1C1E] border border-white/5 overflow-hidden">
        ...
        {/* Settings Group 1 */}
        <View className="mt-8 bg-[#1C1C1E] border-y border-white/5">
           <SettingItem 
        ...
        {/* Settings Group 2 */}
        <View className="mt-6 bg-[#1C1C1E] border-y border-white/5">
           <SettingItem 
        ...
        {/* Action Group */}
        <View className="mt-6 mb-20 bg-[#1C1C1E] border-y border-white/5">
           <SettingItem 
              icon="ban-outline" 
              label={`Block ${name}`} 
              color="#EF4444"
