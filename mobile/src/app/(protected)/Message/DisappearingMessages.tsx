    ...
    <SafeAreaView className="flex-1 bg-black">
      ...
      <ScrollView className="flex-1 px-5" showsVerticalScrollIndicator={false}>
        <View className="items-center py-10">
           <View className="w-20 h-20 rounded-full bg-primary/10 items-center justify-center border border-primary/20 mb-6">
              <Ionicons name="time" size={40} color="#8b5cf6" />
           </View>
        ...
        <TouchableOpacity className="mt-8 flex-row items-center">
           <Text className="text-primary font-rubik-medium">Learn more</Text>
