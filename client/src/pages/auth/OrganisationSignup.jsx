...
import { FaEye, FaEyeSlash, FaFacebookF, FaXTwitter } from "react-icons/fa6";
  ...
  const validateForm = () => {
    ...
    if (!organisation_type) {
      showAlert({
        type: "error",
        message: "Validation Error",
        description: "Please select an organisation type.",
      });
      return false;
    }
    if (!address.trim()) {
      showAlert({
        type: "error",
        message: "Validation Error",
        description: "Official address is required.",
      });
      return false;
    }
    if (!contact_no.trim()) {
                ...
                <div>
                  <Select
                    ...
                    value={organisationTypeOptions.find(
                      (option) => option.value === formData.organisation_type
                    )}
