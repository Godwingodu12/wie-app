...
const EventTermsAndConditionsPage = () => {
    ...
    const handleHostEvent = async (event) => {
        ...
        setError('');
        try {
            await updateTicketTerms(ticketId, {
                terms_accepted: true,
                    ...
                    <div className="w-full max-w-5xl mx-auto">
                        ...
                        <form onSubmit={handleHostEvent} className="space-y-8">
                            ...
                            <div className="pt-6 flex justify-end gap-4">
                                <button type="button" onClick={handleGoBack} className="px-6 py-2.5 rounded-lg font-medium bg-gray-200 dark:bg-[#2B2B2B] text-gray-800 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                                    Go back
                                </button>
