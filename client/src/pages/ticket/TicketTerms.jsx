  ...
  const handleHostEvent = async (event) => {
    ...
    if (!isChecked) {
      showAlert({
        ...
        description:
          "You must agree to the terms and conditions to host the event.",
      });
      return;
    }
    if (!isPreviewChecked) {
      showAlert({
        ...
        description:
          "You must preview the event page and confirm before creating the event.",
      });
      return;
    }
    if (!ticketId) {
                ...
                <div className="h-96 flex flex-col bg-gray-50 dark:bg-[#1C1C1C] rounded-lg border border-gray-300 dark:border-gray-700">
                  <div className="flex-1 overflow-y-auto p-6 space-y-4 text-sm text-gray-600 dark:text-gray-300 custom-scrollbar">
                    ...
                    <p>
                      ...
                      Nullam cursus a quis tincidunt. Volutpat vitae diam sed
                      nisl bibendum leo senectus donec auctor. Dictumst varius
                      feugiat eu elit. Placerat viverra vitae ligula nunc. Lorem
                      ipsum dolor sit amet, consectetur adipiscing elit.
                      Imperdiet accumsan vitae ut nisl vel dolor. Scelerisque
                      vitae quam justo pellentesque cursus justo porttitor
                      bibendum.
                    </p>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Nullam cursus a quis tincidunt. Volutpat vitae diam sed
                      nisl bibendum leo senectus donec auctor. Dictumst varius
                      feugiat eu elit. Placerat viverra vitae ligula nunc.
                    </p>
                    <p>
                      Nullam cursus a quis tincidunt. Volutpat vitae diam sed
                      nisl bibendum leo senectus donec auctor. Dictumst varius
                      feugiat eu elit. Placerat viverra vitae ligula nunc. Lorem
                      ipsum dolor sit amet, consectetur adipiscing elit.
                      Imperdiet accumsan vitae ut nisl vel dolor.
                    </p>
                  </div>
                  <button
                    type="button"
