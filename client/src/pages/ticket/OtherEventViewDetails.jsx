...
const OtherEventViewDetails = () => {
  ...
  const fetchAndSetData = useCallback(async () => {
    ...
    if (!otherId) {
      ...
      setAppAlert({
        message: "Fatal Error",
        description: "Other User ID not found in URL parameters.",
        type: "error",
        show: true,
      });
      setLoading(false);
    ...
    if (!ticketId) {
      ...
      setAppAlert({
        message: "Fatal Error",
        description: "Event ID not found in URL parameters.",
        type: "error",
        show: true,
      });
      setLoading(false);
    ...
    try {
      ...
      if (!data.event_name) {
        throw new Error(
          `Event data is missing event_name. Available keys: ${Object.keys(
            data
          ).join(", ")}`
        );
      }
