...
<div className="flex md:hidden items-center gap-3">
  ...
  className="hidden md:flex w-10 h-10 md:w-12 md:h-12 bg-[linear-gradient(180.23deg,_#1E1242_-0.04%,_#6549B8_99.57%)] rounded-full items-center justify-center hover:scale-105 transition"
                aria-label="back"
              >
<img src={BackArrowIcon} alt="Back" className="w-5 h-5 md:w-6 md:h-6" />
              </button>
            ...
            <div className={`rounded-2xl md:rounded-3xl p-4 md:p-6 lg:p-10`} style={{ backgroundColor: theme.cardBg.replace('bg-', ''), boxShadow: theme.cardShadow }}>
      ...
      <img src={CalenderIcon} alt="calendar" className="w-5 h-5" />
                ...
                <div className="relative w-full">
                  <div className="mx-auto w-full md:w-[85%] lg:w-[80%]">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 md:gap-3 md:pl-[95px]">
                        ...
                        <span className={`text-xs md:text-sm ${theme.subText}`}>{eventData.location || "Online/Recorded"}</span>
                      </div>
                  ...
                  <div className="hidden lg:block">
                    ...
                    >
                      <img src={MapIcon} alt="Map" style={{ width: "clamp(36px, 6vw, 60px)", height: "clamp(36px, 6vw, 60px)" }} />
                    </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8 mb-6 md:mb-8">
                {/* Stats card */}
                <div className={`rounded-2xl md:rounded-3xl px-4 md:px-6 lg:px-8 py-4 md:py-6`} style={{ backgroundColor: theme.cardBg.replace('bg-', ''), boxShadow: theme.smallCardShadow }}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 lg:gap-6 w-full">
                    {[
                      ...
                      <div
                        ...
                        style={{ backgroundColor: theme.innerCardBg.replace('bg-', ''), boxShadow: theme.smallCardShadow, minHeight: '90px' }}
                      >
                        <img
                          src={st.icon}
                          alt=""
                          className={`w-4 h-4 md:w-5 md:h-5 absolute top-3 md:top-6 right-2 md:right-3 ${
                            st.isBlue ? "" : st.needsInvert && !isDark ? "filter brightness-0" : "opacity-80"
                          }`}
                          style={
                            st.isBlue
                              ? {
                ...
                {/* Chart card */}
                <div className={`rounded-2xl md:rounded-3xl px-4 md:px-6 lg:px-8 py-4 md:py-6 flex flex-col`} style={{ backgroundColor: theme.cardBg.replace('bg-', ''), boxShadow: theme.smallCardShadow }}>
                    ...
                    {chartData.map((d, i) => {
                      ...
                      return (
                        <div key={i} className="flex-1 flex flex-col items-center">
                          <span className={`text-[10px] md:text-xs mb-1 md:mb-2 ${theme.subText}`}>{d.value}</span>

                          <div className="relative flex items-end justify-center" style={{ height: baseHeight }}>
                            <div
                          ...
                          <div className={`text-[10px] md:text-xs font-medium mt-2 md:mt-3 ${theme.subText}`}>{d.month}</div>
                        </div>
                      );
                    })}
                  </div>
                ...
                <div className="flex items-center gap-2 w-full overflow-hidden">
                  ...
                  <div className="flex-shrink-0 flex flex-col items-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full flex items-center justify-center">
                      <img src={getImageUrl(eventData.event_banner)} alt="company" className="w-6 h-6 sm:w-8 sm:h-8" />
                    </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className={`rounded-xl sm:rounded-2xl p-2 sm:p-3 shadow-xl flex items-center gap-1.5 sm:gap-2 ${theme.cardBg ?? ''}`} style={{ boxShadow: theme.smallCardShadow }}>
                    ...
                    {[
                      ...
                      <div key={idx} className="flex flex-col items-center flex-shrink-0 w-16 sm:w-20">
                        <button
                          ...
                          style={{ background: "linear-gradient(180.23deg,#1E1242 0%,#6549B8 100%)" }}
              ...
              <div className="hidden md:flex flex-row md:flex-row items-center justify-between gap-4 md:gap-5 mb-6 md:mb-10">
                {/* Company */}
                <div className={`rounded-xl md:rounded-2xl p-4 md:p-6 flex flex-col items-center min-w-[160px] md:min-w-[220px]`}>
                  <div className="w-20 h-20 md:w-[92px] md:h-[92px] bg-white rounded-full flex items-center justify-center mb-2">
                    <img src={getImageUrl(eventData.event_banner)} alt="company" className="w-14 h-14 md:w-16 md:h-16" />
                  </div>
                  <span className={`text-sm md:text-base font-semibold ${theme.text}`}>Company</span>
                </div>

                {/* Add on Events */}
                <div
                  className={`w-full md:w-[50%] rounded-2xl md:rounded-3xl p-3 md:p-4 shadow-xl flex flex-col items-center ${theme.cardBg ?? ''}`}
                  style={{ boxShadow: theme.smallCardShadow }}
                >
                  <div className="flex items-center w-full justify-center relative">
                    <span className={`text-base md:text-lg font-bold mr-4 md:mr-6 pl-4 md:pl-6 ${theme.text}`}>Add on events</span>
                    ...
                    <div className="relative flex-1 flex items-center justify-center" style={{ minHeight: 80 }}>
                      <div className="flex items-center gap-4 md:gap-8 justify-center">
                        {addOnEvents?.map((event, idx) => {
                          ...
                          return (
                            ...
                            >
                              <div
                                className={`flex items-center justify-center rounded-full bg-[#fa62b7] text-white shadow-md w-12 h-12 md:w-16 md:h-16 text-xl md:text-2xl transition-all duration-200 ${isActive ? "ring-2 ring-pink-300/60" : ""}`}
                              >
                                {event.icon}
                              </div>
                            </div>
                        ...
                        {addOnEvents?.map((_, idx) => {
                          ...
                          return (
                            <button
                              key={idx}
                              onClick={() => setActiveIndex(idx)}
                              className={`rounded-full transition-all duration-200 ${isActive ? "w-3 h-3" : "w-2 h-2"}`}
                              style={{
                  ...
                  <div className="overflow-x-visible md:overflow-visible">
                    <div className="flex items-center gap-6 md:gap-16 flex-nowrap px-2 md:px-0 justify-between">
                      {[
                        ...
                        <div key={idx} className="flex flex-col items-center flex-shrink-0 w-20 md:w-auto">
                          <button
                          ...
                          <span className={`text-xs md:text-base mt-2 ${theme.text}`}>{action.label}</span>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              {/* Bank + quarters + donut */}
              <div className={`rounded-xl md:rounded-2xl p-4 md:p-6 mt-6 md:mt-8`} style={{ backgroundColor: theme.cardBg.replace('bg-', ''), boxShadow: theme.smallCardShadow }}>
                <div className="flex flex-col lg:flex-row w-full gap-4 md:gap-6 items-start">
                  ...
                  <div className={`hidden lg:block w-px bg-opacity-50 ${isDark ? 'bg-[#151618]' : 'bg-gray-300'}`} />
                  ...
                  <div className="w-full lg:w-[22%] lg:pl-6 flex flex-col items-center justify-center mt-6 lg:mt-0">
                    ...
                    <p className={`text-center text-xs md:text-sm font-medium ${theme.subText}`}>
                      Total earnings
                    </p>
                  </div>
                </div>
