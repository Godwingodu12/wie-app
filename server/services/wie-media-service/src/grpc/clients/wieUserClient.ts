...
export const incrementPosts = (userId: string): Promise<any> =>
  promisify(client.IncrementPosts, { userId });

export const decrementPosts = (userId: string): Promise<any> =>
  promisify(client.DecrementPosts, { userId });

export const setPostsCount = (userId: string, count: number): Promise<any> =>
  promisify(client.SetPostsCount, { userId, count });
